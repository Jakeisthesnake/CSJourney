...
(define (mc-eval exp env)
  (display "mc-eval ")(display exp)
  (cond ((self-evaluating? exp) (display "self-eval") (newline) exp)
	((variable? exp) (display "var") (newline) (lookup-variable-value exp env))
	((quoted? exp) (display "quoted") (newline) (text-of-quotation exp))
	((definition? exp) (display "def") (newline) (eval-definition exp env))
	((undef? exp) (display "undef") (newline) (eval-undef exp env))
	((if? exp) (display "if") (newline) (eval-if exp env))
	((lambda? exp)
	...
	((begin? exp) (display "begin")(newline) 
	 (eval-sequence (begin-actions exp) env))
	((and? exp) (display "and") (newline) (mc-eval (and->if exp) env))
	((or? exp) (mc-eval (or->if exp) env))
	((cond? exp) (display "cond") (newline) (mc-eval (cond->if exp) env))
	((assignment? exp) (display "assignment") (newline) (eval-assignment exp env))
	((application? exp) (display "application")(newline) 
